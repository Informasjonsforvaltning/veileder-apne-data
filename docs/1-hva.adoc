...
Når andre skal bruke data fra deg, må de ha en avtale som beskriver hva de har lov til å gjøre. En standardisert avtale som gjelder for alle brukere og formål, kalles en åpen lisens. Digdir anbefaler offentlig sektor å lisensiere åpne data under https://creativecommons.org/licenses/by/4.0/deed.no[Creative Commons Navngivelse 4.0] (CC BY 4.0) eller angi fri bruk ved hjelp av https://creativecommons.org/public-domain/cc0/[CC0]. For datasett med antatt internasjonal bruk er CC0 å foretrekke. 
...
Det er det tre hovedgrunner til at tilgang på åpne offentlige data er viktig for samfunnet:
...
* [*] Energiselskapet https://www.otovo.no/[Otovo] er et norsk selskap som leverer solcelle-løsninger for vanlige husholdninger. I stedet for synfaring for å vurdere potensiell strømproduksjon for nye kunder, kan prosessen delvis automatiseres ved å kombinere eksisterende kart- og eiendomsdata om bygninger (https://kartkatalog.geonorge.no/metadata/geovekst/fkb-bygning/8b4304ea-4fb0-479c-a24d-fa225e2c6e97[FKB Bygning])  med åpne data om solforhold fra den europeriske databasen https://re.jrc.ec.europa.eu/pvg_download/data_download.html[PV-GIS]. Otovo anslår at de har spart rundt 300 millioner kroner på utnytte eksisterende datakilder.

* [*] https://www.framsikt.no/[Framsikt AS] leverer styringssystemer for norske kommuner og lager skreddersydde analyseverktøy i hovedsak basert på åpne data fra KOSTRA og andre SSB-data for kommunene. Etter hvert er det mange konsulenter som i stor grad bruker SSB-data. For eksempel Ny analyse, Oslo economics, Menon og Prognosesenteret. SSB tilbyr over 5000 tabeller som åpne data gjennom sitt API for Statistikkbanken.
...
Se https://datalandsbyen.norge.no/category/2/gode-eksempler-p%C3%A5-bruk[Datalandsbyen] og https://data.europa.eu/en/publications/datastories[Data.europa.eu "Data stories"-sider] for flere eksempler på bruk av åpne offentlige data.
...
Eksempel: Mattilsynet tilbyr datasettet https://data.norge.no/datasets/288aa74c-e3d3-492e-9ede-e71503b3bfd9[Smilefjestilsyn på serveringssteder] som åpne data. Datasettet er tilgjengelig i flere maskinleselige formater og tilbys under https://creativecommons.org/licenses/by/4.0/deed.no[Creative Commons Navngivelse 4.0] (CC BY 4.0).

Hvordan et datasett avgrenses og organiseres vil variere mellom ulike virksomheter. Det er altså du (og din virksomhet) som må vurdere hva som er virksomhetens datasett, og hvilke av disse du skal tilby som åpne data. Se https://www.digdir.no/informasjonsforvaltning/veileder-orden-i-eget-hus/2716[Veileder for Orden i eget hus] for å lære mer om hvordan du kan organisere arbeidet med å kartlegge og forvalte data internt i virksomheten.
