...
NOTE: I tråd med anbefalingene i https://www.regjeringen.no/no/dokumenter/nou-2024-14/id3046520/[NOU 2024: 14 Med lov skal data deles] anbefaler Digitaliseringsdirektoratet offentlige virksomheter å lisensiere åpne data med CC0 eller CC 4.0-BY. Dette betyr at Norsk lisens for offentlige data (NLOD) ikke lenger er anbefalt brukt. Data som allerede er lisensiert under NLOD reguleres fortsatt av vilkårene i lisensen, men bør byttes ut med CC0 eller CC 4.0-BY.